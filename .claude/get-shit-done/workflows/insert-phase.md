...
```bash
INIT=$(node "/Users/andrewlastrapes/Desktop/Projects/andrew/gig-tune-generator/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${after_phase}")
...
```bash
RESULT=$(node "/Users/andrewlastrapes/Desktop/Projects/andrew/gig-tune-generator/.claude/get-shit-done/bin/gsd-tools.cjs" phase insert "${after_phase}" "${description}")
```
