...
```bash
node "/Users/andrewlastrapes/Desktop/Projects/andrew/gig-tune-generator/.claude/get-shit-done/bin/gsd-tools.cjs" commit "chore: archive phase directories from completed milestones" --files .planning/milestones/ .planning/phases/
```
